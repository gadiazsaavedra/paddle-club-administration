# Generated by Django 4.2 on 2023-05-07 15:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('padel_admin', '0007_remove_cobramentsoci_soci_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contrasenya', models.CharField(max_length=30, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Pistes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jugador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='padel_admin.jugadors')),
                ('pista', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='padel_admin.pistes')),
                ('recepcionista', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='padel_admin.recepcionista')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jugador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='padel_admin.jugadors')),
                ('recepcionista', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='padel_admin.recepcionista')),
                ('reserva', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='padel_admin.reserva')),
            ],
        ),
        migrations.CreateModel(
            name='CobramentSoci',

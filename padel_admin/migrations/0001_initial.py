# Generated by Django 4.2 on 2025-06-05 01:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Jugadors',
            fields=[
                ('id_jugador', models.CharField(max_length=10, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.DateField()),
                ('soci', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='padel_admin.soci')),
            ],
        ),
        migrations.CreateModel(
            name='Cobrament',
